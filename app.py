...
MASTER_ACCOUNT_ID = '4262891717'  # add main lobby bot account uid
...
def custom_nr_command():
    ...
    if not teamcode:
        return jsonify({'error': 'teamcode parameter are required'}), 400

    results = {}
    
    # Use the same ghost name for all accounts
    ghost_names = {
        "4146829485": "[b][c][ff9999]Nivashini",
        "4143498431": "[b][c][99ff99]insta : [ffff99]ft_rosie._", 
        "4146769736": "[b][c][9999ff]Ꭱꭷနεㅤʚĭɞ",
        "4144498636": "[b][c][ff99ff]Ꭱꭷနεㅤʚĭɞ",
        "4049472315": "[b][c][ffff99]insta :[99ff99] ft_rosie._"
    }
